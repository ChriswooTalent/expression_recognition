...
__all__ = ['mobileDensenetCL_2', 'mobileDensenetCL_1', 'mobileDensenetCL_075', 'mobileDensenetCL_05', 'mobileDensenetCL_025']
...
class MobileDenseNet_CL(nn.Module):
    def __init__(self, widen_factor=1.0, num_classes=1000, prelu=False, input_channel=3):
        ...
        """
        super(MobileDenseNet_CL, self).__init__()
        ...
        self.Densefc0 = nn.Linear(int(2048 * widen_factor), int(512 * widen_factor))

        self.Densefc1 = nn.Linear(int(512 * widen_factor), num_classes)
    ...
    def forward(self, x):
        ...
        x = x.view(x.size(0), -1)
        ip1 = self.reluip1(x)
        ip1 = self.Densefc0(ip1)
        ip2 = self.Densefc1(ip1)

        return ip1, F.log_softmax(ip2, dim=1)


def mobileDensenetCL(widen_factor=1.0, num_classes=1000):
    """
    Construct MobileNet.
    ...
    """
    model = MobileDenseNet_CL(widen_factor=widen_factor, num_classes=num_classes)
    return model


def mobileDensenetCL_2(num_classes=62, input_channel=3):
    model = MobileDenseNet_CL(widen_factor=2.0, num_classes=num_classes, input_channel=input_channel)
    return model


def mobileDensenetCL_1(num_classes=62, input_channel=3):
    model = MobileDenseNet_CL(widen_factor=1.0, num_classes=num_classes, input_channel=input_channel)
    return model


def mobileDensenetCL_075(num_classes=62, input_channel=3):
    model = MobileDenseNet_CL(widen_factor=0.75, num_classes=num_classes, input_channel=input_channel)
    return model


def mobileDensenetCL_05(num_classes=62, input_channel=3):
    model = MobileDenseNet_CL(widen_factor=0.5, num_classes=num_classes, input_channel=input_channel)
    return model


def mobileDensenetCL_025(num_classes=62, input_channel=3):
    model = MobileDenseNet_CL(widen_factor=0.25, num_classes=num_classes, input_channel=input_channel)
    return model