...
__all__ = ['mobilenetv1CL_2', 'mobilenetv1CL_1', 'mobilenetv1CL_075', 'mobilenetv1CL_05', 'mobilenetv1CL_025']
...
class MobileNetV1CL(nn.Module):
    def __init__(self, widen_factor=1.0, num_classes=1000, prelu=False, input_channel=3):
        ...
        """
        super(MobileNetV1CL, self).__init__()
        ...
        self.reluip1 = nn.PReLU()

        self.avgpool = nn.AdaptiveAvgPool2d(1)

        self.fc_ip1 = nn.Linear(int(1024 * widen_factor), num_classes)
...
def mobilenetv1CL(widen_factor=1.0, num_classes=1000):
    """
    Construct MobileNet.
    ...
    """
    model = MobileNetV1CL(widen_factor=widen_factor, num_classes=num_classes)
    return model


def mobilenetv1CL_2(num_classes=62, input_channel=3):
    model = MobileNetV1CL(widen_factor=2.0, num_classes=num_classes, input_channel=input_channel)
    return model


def mobilenetv1CL_1(num_classes=62, input_channel=3):
    model = MobileNetV1CL(widen_factor=1.0, num_classes=num_classes, input_channel=input_channel)
    return model


def mobilenetv1CL_075(num_classes=62, input_channel=3):
    model = MobileNetV1CL(widen_factor=0.75, num_classes=num_classes, input_channel=input_channel)
    return model


def mobilenetv1CL_05(num_classes=62, input_channel=3):
    model = MobileNetV1CL(widen_factor=0.5, num_classes=num_classes, input_channel=input_channel)
    return model


def mobilenetv1CL_025(num_classes=62, input_channel=3):
    model = MobileNetV1CL(widen_factor=0.25, num_classes=num_classes, input_channel=input_channel)
    return model